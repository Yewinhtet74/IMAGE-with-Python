# -*- coding: utf-8 -*-
"""
Created on Mon Apr  3 09:50:05 2023
...
img = cv2.imread("images/ballons.tif", 1)
...
background = (blue_channel <= 80)
nuclei = (blue_channel > 80)
...
ret1, thresh1 = cv2.threshold(blue_channel, 80, 255, cv2.THRESH_BINARY)
