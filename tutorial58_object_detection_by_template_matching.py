...
img_rgb = cv2.imread('images/coins.png')
img_gray = cv2.cvtColor(img_rgb, cv2.COLOR_BGR2GRAY)
template = cv2.imread('images/coins_template.png', 0)
h, w = template.shape[::] 
...
cv2.rectangle(img_gray, top_left, bottom_right, 0, 1) #color and tickness #Black rectangle with thickness 2. 
...
img_rgb = cv2.imread('images/coins.png')
img_gray = cv2.cvtColor(img_rgb, cv2.COLOR_BGR2GRAY)
template = cv2.imread('images/coins_template2.png', 0)
h, w = template.shape[::]
