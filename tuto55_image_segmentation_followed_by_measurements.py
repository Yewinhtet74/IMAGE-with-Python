...
plt.histc  #.flat returns the flattened numpy array (1D)
...
plt.imsave("images/cast_iron1_labeled.jpg", image_label_overlay) 
...
df.to_csv('images/converted/cast_iron_measurements.csv')
